...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights", type=str, required=False, help="Path to the '.weights' file to be loaded.")
    parser.add_argument("--model", type=str, required=False, help="Path to the '.model' file to be loaded.")
    parser.add_argument("--video-path", type=str, required=False, help="Path to a .mp4 file (Minecraft recording).")
    ...
    import os
    workdir = os.path.expanduser('~') + "/workspace/vpt"
    args.weights = workdir + "/data/4x_idm.weights"
    args.model = workdir + "/data/4x_idm.model"
    args.video_path = workdir + "/data/cheeky-cornflower-setter-02e496ce4abb-20220421-092639.mp4"
    args.jsonl_path = workdir + "/data/test_output.jsonl"
